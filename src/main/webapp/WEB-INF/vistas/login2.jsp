...
<head>
    ...
    <link href="https://demos.creative-tim.com/blk-design-system/assets/css/nucleo-svg.css" rel="stylesheet" />
    <!-- Font Awesome Icons -->
    <script src="https://kit.fontawesome.com/42d5adcbca.js" crossorigin="anonymous"></script>


    <link id="pagestyle" href="https://demos.creative-tim.com/argon-dashboard/assets/css/argon-dashboard.min.css?v=2.0.4"
          rel="stylesheet" />
                ...
                <div class="row">
                    <div class="col-6 d-lg-flex d-none h-100 my-auto pe-0 position-absolute top-0 start-0 text-center justify-content-center flex-column">
                        <div class="position-relative bg-gradient-primary h-100 m-3 px-7 border-radius-lg d-flex flex-column justify-content-center overflow-hidden background-size: cover;">
                            <img src="https://raw.githubusercontent.com/gonzalopez-ml/TPINT_GRUPO_3_LAB4/main/src/main/webapp/WEB-INF/assets/img/login.png">
                        ...
                        <div class="col-xl-4 col-lg-5 col-md-7 d-flex flex-column mx-lg-0 mx-auto">
                            ...
                            <div class="card-header pb-0 text-start">
                                <div class="d-flex align-items-center justify-content-center">
                                    <img src="https://github.com/gonzalopez-ml/TPINT_GRUPO_3_LAB4/blob/main/src/main/webapp/WEB-INF/assets/img/tree.png?raw=true">
