...
<body>
  ...
  <main class="main-content position-relative border-radius-lg ">
    ...
    <i class="fas fa-search"></i>
                ...
                <button class="btn btn-primary btn-sm ms-auto" onclick="window.location.href='tipos.html'">NUEVO</button>
              </div>
            </div>
            <div class="card-body">
              <div class="row">
    ...
    <tr>
      <td><label for="example-text-input" class="label-input">12451</label></td>
      <td><label for="example-text-input" class="label-input">Reloj</label></td>
    ...
    <tr>
      ...
      <td><label for="example-text-input" class="label-input">Pantallas</label></td>
      <td class="action-icons-col">
         <div class="actions">
		<i class="fas fa-pencil-alt"></i>
        <i class="fas fa-trash"></i>
    ...
    <tr>
      <td><label for="example-text-input" class="label-input">54567</label></td>
      <td><label for="example-text-input" class="label-input">Mouse</label></td>
    ...
    <tr>
      <td><label for="example-text-input" class="label-input">65678</label></td>
      <td><label for="example-text-input" class="label-input">Motherboard</label></td>
    ...
    <tr>
      <td><label for="example-text-input" class="label-input">53489</label></td>
      <td><label for="example-text-input" class="label-input">Teclados</label></td>
