...
<body>
  ...
  <main class="main-content position-relative border-radius-lg ">
    ...
    <i class="fas fa-search"></i>
                 ...
                 <button class="btn btn-primary btn-sm ms-auto" onclick="window.location.href='marcas.html'">NUEVO</button>
              </div>
            </div>
            <div class="card-body">
              <div class="row">
    ...
    <tr class="form-control-label">
      ...
      <th>  <label for="example-text-input" class="form-control-label">MARCA</label></th>
    ...
    <tr>
      ...
      <td><label for="example-text-input" class="label-input">Tuskmar</label></td>
    ...
    <tr>
      <td><label for="example-text-input" class="label-input">23434</label></td>
      <td><label for="example-text-input" class="label-input">Oracle</label></td>
      <td class="action-icons-col">
         <div class="actions">
		<i class="fas fa-pencil-alt"></i>
        <i class="fas fa-trash"></i>
    ...
    <tr>
      <td><label for="example-text-input" class="label-input">23567</label></td>
      <td><label for="example-text-input" class="label-input">Microsoft</label></td>
    ...
    <tr>
      <td><label for="example-text-input" class="label-input">12678</label></td>
      <td><label for="example-text-input" class="label-input">AMD</label></td>
    ...
    <tr>
      <td><label for="example-text-input" class="label-input">5334</label></td>
      <td><label for="example-text-input" class="label-input">Samsung</label></td>
