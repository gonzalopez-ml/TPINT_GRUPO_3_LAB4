...
<table id="tabla" class="display" style="text-align: center;">
    ...
    <% for (Usuario usuario1 : usuarios) { %>
        <tr style="text-align: center">
            ...
            <td> <form action="eliminarUsuario.html" onclick="return confirm('¿Estás seguro de continuar, se eliminará el usuario?')" method="get">
            ...
            <% if (usuario1.getTipoUsuario() == TipoUsuarioEnum.admin) { %>
                ...
                <form action="modificarUsuario.html" method="get">
                    <input type="hidden" name="idUsuario" value="<%= usuario1.getId() %>">
                    <button type="submit"
