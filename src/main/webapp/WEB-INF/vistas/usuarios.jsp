    ...
    <div>
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
		 ...
		 <li class="nav-item ms-2">
         <a class="nav-link " href="marcas.html"> <h6 class="ps-4 ms-2 text-uppercase text-xs  opacity-6 ">MARCAS</h6></a>
        </li>
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input class="form-control" type="text" value="25964574">
                  </div>
                </div>
                <div class="col-md-6">
              ...
              <div class="row">
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <input class="form-control" type="text" value="luckyman123">
                  </div>
