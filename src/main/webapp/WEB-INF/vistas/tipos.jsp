    ...
    <div>
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
         ...
         <a class="nav-link " href="tipos-list.html"> <h6 class="ps-4 ms-2 text-uppercase text-xs  opacity-6 fas fa-chevron-right">TIPOS</h6></a>
        </li>
		 <li class="nav-item ms-2">
         <a class="nav-link " href="marcas-list.html"> <h6 class="ps-4 ms-2 text-uppercase text-xs  opacity-6 fas fa-chevron-right">MARCAS</h6></a>
        </li>
